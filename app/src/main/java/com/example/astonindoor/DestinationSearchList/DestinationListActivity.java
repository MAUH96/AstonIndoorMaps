...
public class DestinationListActivity extends AppCompatActivity implements SearchListAdapter.onRoomListener {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setQueryHint("Search a destination room");
    ...
    public void onRoomClick(final int position) throws JSONException {
        ...
        Intent intent = new Intent(DestinationListActivity.this, MapsActivity.class);
